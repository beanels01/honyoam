let
    ...
    path=               require('path'),
    mime=               require('mime'),
    entries=            require('./HttpServer/entries'),
    loadRequestMethods= require('./HttpServer/loadRequestMethods')
function HttpServer(config){
    this.config=Object.create(config)
    this.computed={
        host:           new URL(this.config.host),
        allowedOrigin:  new URL(this.config.allowedOrigin),
    }
