...
import cropImageUploader from   '../cropImageUploader.js'
import block0 from './inputForSpecificLanguage/block0.js'
import block1 from './inputForSpecificLanguage/block1.js'
import investJapan from './inputForSpecificLanguage/investJapan.js'
import inputOption from './inputForSpecificLanguage/inputOption.js'
import speakersInput from './inputForSpecificLanguage/speakersInput.js'
import flowInput from './inputForSpecificLanguage/flowInput.js'
let
    options={
        placeholder:'內文',
        modules:{
