import header from './_homepageLike/header.js'
import menu from './_homepageLike/menu.js'
import footer from './_homepageLike/footer.js'
import langToPath from './_homepageLike/langToPath.js'
